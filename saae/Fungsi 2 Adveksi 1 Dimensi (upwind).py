...
ax.set_title(f"Adveksi 1D - Dua Pulsa Saling Menyusul")
...
# ANIMASI
ani = FuncAnimation(fig, update, frames=1100, interval=30, blit=True)
ani.save('2 Adveksi 1 Dimensi.mp4', writer='ffmpeg', fps=30, dpi=150) 
plt.show()